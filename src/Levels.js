    ...
    if (checkCollision(this.player, enemy)) {
      if (
        ...
        if (enemy === this.bossEnemy) {
          this.player.position.x -= this.bossEnemy.width; // This really is a terrible way to handle this but it works...
        }
...
export class LevelBoss extends Level {
  ...
  update(deltaTime) {
    super.update(deltaTime);
    this.delayLevelComplete();
    this.triggerWinCondition(this.bossDefeated);
  }
  delayLevelComplete() {
