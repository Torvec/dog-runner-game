...
class Scene {
  ...
  update(input) {
    this.currentState.changeState(input);
...
export class StartMenu extends Scene {
  constructor(game) {
    ...
    this.gameTitleText = "The Running Dog";
    this.startGameText = "Press Enter to Play";
  }
  draw(c) {
    super.draw(c);
    c.fillStyle = "WHITE";
...
export class HowToPlay extends Scene {
  constructor(game) {
    ...
    this.gameTitleText = "How to Play";
    this.startGameText = "Press Enter to Skip";
  }
  draw(c) {
    super.draw(c);
    c.fillStyle = "WHITE";
