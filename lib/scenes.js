...
class GameLevel {
  ...
  //TODO: Find a way to only need one restart method that will work on all levels and doesn't need to be overridden
  // restart() {
  //   this.game.setScene(this.game.currentScene);
  // }
}
