...
export class Player {
  constructor(level) {
    ...
    this.position = {
      x: 0,
      y: this.level.height - this.height - this.level.groundMargin,
    };
  ...
  update(input, deltaTime) {
    ...
    if (this.position.x > this.level.width - this.width)
      this.position.x = this.level.width - this.width;
    // Vertical movement
    ...
    if (
      this.position.y >
      this.level.height - this.height - this.level.groundMargin
    )
      this.position.y =
        this.level.height - this.height - this.level.groundMargin;
    // Sprite Animation
