...
export class SplashScreen {
  ...
  update() {
    this.handleMenuChange(this.game.input.keys);
  }
  draw(c) {
...
export class HowToPlay {
  ...
  draw(c) {
    ...
    c.font = "24px sans-serif";
    c.fillText(
      menuData.keys.escape + menuData.howToPlay.controls.pauseLevel,
      this.width * 0.5,
      this.height * 0.5 - 60
    );
    c.fillText(
      menuData.keys.p + menuData.howToPlay.controls.pauseMusic,
      this.width * 0.5,
      this.height * 0.5 - 20
    );
    c.font = "32px Impact";
    ...
    c.font = "24px sans-serif";
    c.fillText(
      menuData.keys.space + menuData.howToPlay.controls.shoot,
      this.width * 0.8,
      this.height * 0.5 - 60
    );
    c.fillText(
