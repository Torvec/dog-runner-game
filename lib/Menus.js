...
import { getHighestScore, getHighestFinalScore } from "./ScoreStorage.js";
...
export class GameComplete extends Menu {
  ...
  draw(c) {
    ...
    c.textAlign = "center";
    c.fillText(
      menuData.gameComplete.score + getHighestFinalScore(),
      this.width * 0.5,
      this.height * 0.5
    );
    c.font = "24px Impact";
