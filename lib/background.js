...
export class BackgroundStartMenu extends Background {
  constructor(game) {
    ...
    this.height = 500;
    this.layerImages = [
      { src: "../assets/bg-city/layer-3.png", speedModifier: 0 },
      { src: "../assets/bg-forest/layer-5.png", speedModifier: 0 },
    ];
...
export class BackgroundLevelThree extends Background {
  constructor(game) {
    ...
    this.layerImages = [
      ...
      { src: "../assets/bg-city/layer-2.png", speedModifier: 0.1 },
      { src: "../assets/bg-city/layer-3.png", speedModifier: 0.3 },
      { src: "../assets/bg-city/layer-4.png", speedModifier: 0.6 },
