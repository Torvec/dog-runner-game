...
import { BackgroundMusic } from "./Sound.js";
...
export class Game {
  constructor(canvas) {
    ...
    this.backgroundMusic = new BackgroundMusic(this, "loop_run_for_your_life_02.wav");
    this.sceneKeys = [];
  ...
  render(deltaTime, c) {
    ...
    this.backgroundMusic.handlePauseAndPlay(this.input.keys);
  }
}
