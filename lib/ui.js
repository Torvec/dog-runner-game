export class UI {
  constructor(gameLevel) {
    ...
    this.livesImage.src = "../assets/sprites-ui/lives.png";
  ...
  draw(context) {
    ...
    context.fillStyle = this.gameLevel.fontColor;

    // Score
    context.fillText(this.scoreText + this.gameLevel.score, 20, 50);
    // Timer
    context.font = this.fontSize + this.fontFamily;
    context.fillText(
      this.timeText + (this.gameLevel.time * 0.001).toFixed(1),
      20,
      80
    );
    // Lives
    ...
    if (this.gameLevel.gameOver) {
      ...
      // Win Game Message
      if (this.gameLevel.score > this.gameLevel.winningScore) {
        context.font = this.fontSizeLarge + this.fontFamily;
        context.fillText(
          this.gameOverText,
          this.gameLevel.width * 0.5,
          this.gameLevel.height * 0.5 - 20
        );
    ...
    // Game Paused
    if (this.gameLevel.isPaused && !this.gameLevel.gameOver) {
      context.textAlign = "center";
      context.font = this.fontSizeLarge + this.fontFamily;
      context.fillText(
        this.gamePausedText,
        this.gameLevel.width * 0.5,
        this.gameLevel.height * 0.5
      );
    }
    context.restore();
  }
